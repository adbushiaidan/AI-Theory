...
Digital representation of an image
    ...
    Each pixel stores its brightness (or intensity) ranging from 0 to 255, 0.
...
Convolutional vs fully connected layer
    ...
    300x300 input, 300x300 output, 5x5 kernel – 26 parameters in convolutional layer and 8.1×10B parameters in fully connected layer (each output is a
perceptron);
